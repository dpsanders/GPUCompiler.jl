...
function code_native(io::IO, job::CompilerJob{SPIRVCompilerTarget};
                     raw::Bool=false, strict::Bool=false)
    obj, _ = GPUCompiler.codegen(:obj, job; strip=!raw, strict=strict)
